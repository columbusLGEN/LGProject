...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HXWeiboPhotoPicker/HXWeiboPhotoPicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XHNetworkCache/XHNetworkCache.framework"
